<?php
	...
	$ans="SELECT users.first_name, users.last_name, posts.title, posts.description, posts.image FROM posts INNER JOIN users ON posts.user_id = users.id WHERE posts.id = '$post_id' ";
